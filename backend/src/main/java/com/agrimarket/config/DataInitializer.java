    ...
    private void loadProduits() {
        if (produitRepository.count() == 0) {
            ...
            if (agriculteurs.size() >= 2 && categories.size() >= 2) {
                ...
                tomates.setQuantiteDisponible(50);
                ...
                pommes.setQuantiteDisponible(100);
                ...
                laitue.setQuantiteDisponible(75);
                ...
                menthe.setQuantiteDisponible(30);
                ...
                fraises.setQuantiteDisponible(40);
                ...
                carottes.setQuantiteDisponible(80);
